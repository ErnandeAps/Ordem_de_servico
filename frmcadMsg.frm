...
Begin VB.Form frmcadMsg 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Cadastro de Msg email"
   ClientHeight    =   4290
   ClientLeft      =   5775
   ClientTop       =   4380
   ClientWidth     =   6345
   ClipControls    =   0   'False
   Icon            =   "frmcadMsg.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4290
...
Sql = "DELETE from tbmsg where id=" & nIdac & ""
...
Sql = "INSERT INTO tbmsg (titulo,msg) VALUE ('" & ctdescricao & "', '" & ctMsg & "')"
...
With DataAdo
        ...
        .RecordSource = "Select * From tbmsg order by titulo ASC"
   End With
    DataAdo.Refresh
End Sub
