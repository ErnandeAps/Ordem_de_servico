...
Begin VB.Form frmcadServicos 
   ...
   Begin VB.CommandButton cmdInsert 
      Height          =   435
      Left            =   5250
      Picture         =   "frmcadServicos.frx":5C12
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   240
      Width           =   525
   ...
   Begin VB.CommandButton cmdExcluir 
      Height          =   435
      Left            =   5790
      Picture         =   "frmcadServicos.frx":61DB
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   240
      Width           =   495
   ...
   Begin MSDataGridLib.DataGrid dbgacessorios 
      Bindings        =   "frmcadServicos.frx":6726
      Height          =   3105
      Left            =   90
      TabIndex        =   1
      Top             =   690
...
Sql = "DELETE from cadservicos where id=" & nIdac & ""
...
Sql = "INSERT INTO cadservicos (descricao) VALUE ('" & ctdescricao & "')"
...
With DataAdo
        ...
        .RecordSource = "Select * From cadservicos order by id"
   End With
    DataAdo.Refresh
End Sub
