...
Begin VB.Form frmtbNserie 
   ...
   Caption         =   "Assistente de cadastro de N° Série"
   ClientHeight    =   3615
   ClientLeft      =   5940
   ClientTop       =   4605
   ClientWidth     =   8505
   ...
   Begin MSAdodcLib.Adodc DataAdo 
      ...
      Password        =   ""
      RecordSource    =   ""
      Caption         =   "Relação de N° de série por item"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Menu mnuRel 
      ...
      Begin VB.Menu mnuRelRelSeriePecas 
         Caption         =   "Relação de N° de Série por peças"
      End
   End
End
...
Case vbKeyReturn
    ...
    If cbPecas.Text = "" Then
        MsgBox "Selecione uma ítem para continuar.", vbCritical
        Exit Sub
    End If
...
On Error GoTo E:
nID = InputBox("Digite o id do ítem para continuar.")
...
If Err.Number = 13 Then
    MsgBox "Ítem inválido.", vbCritical
    Exit Sub
End If
End Sub
